...
from continual_model import train_model, contin_learn_forget, build_optimizer
...
params = {
    ...
    'path2avg': 'cifar10_cnn2_adam_P5_C2_forget_avg_index1',  # path to csv file you keep the average forget performance
...
test_file_name = 'test_' + params['ds_type'] + '_' + params['nn_type'] + '_' + params['optimizer'] + '_' + params['sim_type'] + '_' + 'P' + str(params['num_task']) + '_C' + str(params['num_output_classes']) + '_opt_forget_index' + str(params['num_index'])
